...
class ComprobanteRetencion extends StatelessWidget {
  ComprobanteRetencion({super.key});
  final controller = Get.put(ComprobanteRetencionController());
              ...
              child: Row(
                ...
                children: [
                  ...
                  Obx(() => GenericConsultButton(
                    isLoading: controller.cargando.value,
                    onConsult: () async {
                      await controller.cargarComprobante(

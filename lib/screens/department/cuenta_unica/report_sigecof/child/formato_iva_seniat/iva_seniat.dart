...
import 'controller/iva_seniat_controller.dart';

class IvaSeniat extends StatelessWidget {
  IvaSeniat({super.key});
  final controller = Get.put(IvaSeniatController());
              ...
              child: Row(
                ...
                children: [
                  ...
                  Obx(() => GenericConsultButton(
                    isLoading: controller.cargando.value,
                    onConsult: () async {
                      await controller.cargarIvaSeniat(

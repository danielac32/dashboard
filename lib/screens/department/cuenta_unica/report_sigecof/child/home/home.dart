import 'package:core_system/screens/department/cuenta_unica/CuentaUnica.dart';
...
class Home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CuentaUnicaHomeScreen();
  }
}


class CuentaUnicaHomeScreen extends StatelessWidget {
  const CuentaUnicaHomeScreen({super.key});

...
import '../model/RetencionResponse.dart';
//import '../service/Service.dart';
...
class RetencionController extends GetxController {
  var filtro = ''.obs;
  var datos = <RetencionResponse>[].obs;
  //var resultados = <RetencionResponse>[].obs;
  var cargando = false.obs;
  final currentPage = 0.obs;
  final itemsPerPage = 20.obs;
  final paginatedResults = <RetencionResponse>[].obs;
  ...
  Future<void> descargarReporte() async {
    ...
    try {
      ...
      // Nombre del archivo
      final fileName = 'reporte_retencion_${DateFormat('yyyyMMdd').format(DateTime.now())}.xlsx';

...
class IvssController extends GetxController {
  ...
  Future<void> cargarPagadas(DateTime desde, DateTime hasta) async {
    ...
    try {
      ...
      jsonDataAlmacenado.clear();
      final jsonData = await ServiceIvss.post('api/query/ivss/pagadas', {}, queryParams: queryParams);
  ...
  Future<void> descargarReporte() async {
    ...
    try {
      ...
      // Nombre del archivo
      final fileName = 'ivss_pagadas_${DateFormat('yyyyMMdd').format(DateTime.now())}.xlsx';

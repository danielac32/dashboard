...
class IvssPendientesController extends GetxController {
  ...
  var reporteDescargado = false.obs;
  ...
  Future<void> cargarPendientes(DateTime desde, DateTime hasta) async {
    ...
    try {
      ...
      jsonDataAlmacenado.clear();
      final jsonData = await ServiceIvss.post('api/query/ivss/pendientes', {}, queryParams: queryParams);
  ...
  Future<void> descargarReporte() async {
    ...
    try {
      ...
      // Nombre del archivo
      final fileName = 'ivss_pendientes_${DateFormat('yyyyMMdd').format(DateTime.now())}.xlsx';

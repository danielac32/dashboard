...
class PendientesIvss extends StatelessWidget {
  PendientesIvss({super.key});
  final controller = Get.put(IvssPendientesController());
...
class Download extends StatelessWidget {
  ...
  final IvssPendientesController controller;
